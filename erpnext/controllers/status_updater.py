...
status_map = {
	...
	"Sales Order": [
		["Draft", None],
		["To Pick", "eval:self.per_picked > 1 and self.per_delivered < 100 and self.per_billed == 100 and self.docstatus == 1"],
		["To Pick and Bill", "eval:self.per_picked > 1 and self.per_delivered < 100 and self.per_billed < 100 and self.docstatus == 1"],
