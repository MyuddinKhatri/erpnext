...
status_map = {
	...
	"Sales Order": [
		["Draft", None],
		["To Pick", "eval:not self.ignore_pick_list and self.per_picked < 100 and self.per_delivered < 100 and self.per_billed == 100 and self.docstatus == 1"],
		["To Pick and Bill", "eval:not self.ignore_pick_list and self.per_picked < 100 and self.per_delivered < 100 and self.per_billed < 100 and self.docstatus == 1"],
